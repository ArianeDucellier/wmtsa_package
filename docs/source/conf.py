...
project = "wmtsa"
copyright = f"{date.today().year}, ArianeDucellier"
author = "ArianeDucellier"
...
# LinkCode
code_url = f"https://github.com/ArianeDucellier/wmtsa_package/blob/{git_commit}"
